...
function cleanretina_theme_options_validate( $options ) {
   ...
   // data validation for Social Icons
	...
	if( 0 == $input_validated[ 'reset_foooterinfo' ] ) {
		...
		$input_validated['footer_code'] = $cleanretina_theme_options_defaults[ 'footer_code' ];
	}
