...
$template_url = get_template_directory_uri(); 
  ...
  $evl_main_pattern = evl_get_option('evl_pattern','pattern_7.png');
  $evl_scheme_widgets = evl_get_option('evl_scheme_widgets','blue-back.jpg');
...
.menu-container {background-image: url('.$template_url.'/library/media/images/dark/main-bg-dark.jpg);}  
