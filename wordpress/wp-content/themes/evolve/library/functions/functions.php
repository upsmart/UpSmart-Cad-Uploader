...
function evolve_media() {
  ...
  wp_enqueue_style('googlefont', "http://fonts.googleapis.com/css?family=Nobile:r,b,i|Goudy+Bookletter+1911:r,b,i|Open+Sans:r,b,i|Quattrocento:r,b,i|Droid+Serif:r,b,i|Pacifico:r,b,i");
