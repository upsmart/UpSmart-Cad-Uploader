...
function optionsframework_page() {
	settings_errors(); ?>
    <?php $theme = wp_get_theme(); if ( $theme->name == 'GamePress' ) : ?>
    <div id="optionsframework-themepromo">
        <h2><?php _e('Upgrade to GamePress Pro!','gamepress'); ?></h2>
        <p><?php _e('All GamePress features plus <b>responsive design</b>, beautiful <b>light skin</b> and <b>lifetime updates</b>.','gamepress'); ?> <a href="http://webtuts.pl/gamepress-pro/"><?php _e('Buy now!','gamepress'); ?></a></p>
	</div>
    <?php endif; ?>
