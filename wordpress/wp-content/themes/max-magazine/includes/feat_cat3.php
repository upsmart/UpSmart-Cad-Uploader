...
<div class="category">
	<h3 class="cat-title"><a href="<?php echo esc_url( $cat3_url ); ?>" ><?php echo $cat3_name; ?></a></h3>
	
		<div class="feat-post"> 
			<?php $post_query = 'cat='.$cat3_id.'&posts_per_page=1'; ?>
		...
		<div class="more-posts">
			...
			<?php $post_query = 'cat='.$cat3_id.'&posts_per_page=3&offset=1'; ?>
				<?php query_posts( $post_query ); ?>
					<?php if (have_posts()) : ?>
						<?php while (have_posts()) : the_post(); ?>	
