...
function max_magazine_facebook_widget() {
		...
		/* Widget settings */
		$widget_ops = array( 'classname' => 'widget_facebook', 'description' => __('A widget to display your facebook like box.', 'max-magazine') );

		/* Create the widget */
		$this->WP_Widget( 'max_magazine_facebook_widget', __('Max: Facebook Likebox', 'max-magazine'), $widget_ops );
	}
