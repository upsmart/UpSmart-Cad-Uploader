...
?>
 <div class="trail-notify">
        <h1>Upgrade to Poloray Theme PRO!</h1>
        <p>You are Using the Lite Version of Poloray Theme, Upgrade to Pro to get more Home Page Image Slider, Added HomePage Sections, Gallery, Contact Page Template, Premium Support and more.</p>
        <a href="http://www.inkthemes.com/wp-themes/poloray-responsive-wordpress-theme/" target="blank">Click Here to Upgrade to Poloray Theme PRO !</a>
    </div>
...
<script type="text/javascript" language="javascript">
		jQuery(document).ready(function(){
			...
			//Color Picker
			<?php $options = poloray_get_option('of_template');
...
function poloray_optionsframework_uploader_function($id,$std,$mod){
	...
	if($mod != 'min') { 
			$val = $std;
            if ( poloray_get_option( $id ) != "") { $val = poloray_get_option($id); }
